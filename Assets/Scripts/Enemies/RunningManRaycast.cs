...
public class RunningManRaycast : MonoBehaviour
{
    ...
    private RunningManMovement runningManMovement;
    ...
    void Start()
    {
        ...
        runningManMovement = GetComponentInParent<RunningManMovement>();
    }
    ...
    void Update()
    {
        ...
        else if (playerDistance <= detectionRadius)
        {
            ...
            if (runningManMovement.GetEnemySpeedX() != 0)
                direction = runningManMovement.GetEnemySpeedX();
